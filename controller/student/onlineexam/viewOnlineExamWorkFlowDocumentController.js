colorAdminApp.controller('viewOnlineExamWorkFlowDocumentController', function ($scope, $rootScope, $http, $state,$stateParams, DTOptionsBuilder, DTColumnBuilder, $filter, $compile) {
    ...
    $scope.orderColumns = [
        ...
        DTColumnBuilder.newColumn("", "Exam").withClass("f-s-600 text-inverse").withOption('name', 'Exam').renderWith(function (data, type, full) {
            var html = "<table>";
 ...
 DTColumnBuilder.newColumn("", "Student").withClass("f-s-600 text-inverse").withOption('name', 'Student').renderWith(function (data, type, full) {
            var html = "<table>";
        ...
        DTColumnBuilder.newColumn("", "Teacher").withClass("f-s-600 text-inverse").withOption('name', 'Teacher').renderWith(function (data, type, full) {
                    var html = "<table>";
