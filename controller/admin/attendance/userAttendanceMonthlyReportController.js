colorAdminApp.controller('userAttendanceMonthlyReportController', function ($scope, $rootScope, $http, $state, $stateParams) {
    ...
    $scope.getAttendanceMonthlyReport = function () {
        ...
        $http.post($scope.webApiUrl + 'admin/GetUserAttendanceMonthlyReport', JSON.stringify({
            apiKey: $scope.school.appKey, adminId: $scope.user.entityId, entityId: $stateParams.entityId,roleId: $stateParams.roleId, academicYearId: $scope.academicYear.academicYearId,
